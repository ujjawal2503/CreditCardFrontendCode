...
class RegisterCustomer extends Component {
    ...
    submitHandler = (event) => {
        ...
        if (validateForm(this.state.errors)) {
            ...
            axios.post('http://localhost:9090/customer/addCustomer', this.state)
                .then(response => {
                ...
                <div className="container">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3" style={{ opacity: 0.7, fontWeight: "bold", fontSize: 18, backgroundColor: 'black', color: 'white' }}>
                            <h3 className="text-center w4-padding w3-xlarge w3-text-white">Add Customer</h3>
                            <div className="card-body">
                                <form onSubmit={this.submitHandler} noValidate autoComplete="off">
                                    ...
                                    {/* <br/> */}
                                    <div className="form-group">
                                        <label className="w4-padding w2-xlarge w3-text-whte">Password</label>
                                        <input className="form-control mt-2"
                                            type="password"
                                            name="password"
                                            value={password}
                                    ...
                                    <button style={{ marginBottom: "70px" }} className="btn btn-success mr-1" type="submit">Save</button>
